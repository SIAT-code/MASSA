...
class Trainer(object):
    ...
    def train(self, dataset_tuple, device, dir_input, data_type):
        ...
        for step, batch in enumerate(zip(dataloader, dataloaderstruc)):
            ...
            seq_tokens, go_tokens, pro_ids, goterms, proteins_num, goterms_num, compounds_num, labels, atoms, bonds, atom_degrees, bond_degrees, atom_masks = batch1
            ...
            atoms, bonds, atom_degrees, bond_degrees, atom_masks, compounds_num = atoms.to(device), bonds.to(device), atom_degrees.to(device), bond_degrees.to(device), atom_masks.to(device), compounds_num.to(device)
            ...
            data_pack = (pro_seqs, batch2, gpu_split, goterms, proteins_num, goterms_num, compounds_num, atoms, bonds, atom_degrees, bond_degrees, atom_masks)
