...
class ClassificationLayer(nn.Module):
    def __init__(self, pro_hid_dim):
        ...
        self.fc2 = nn.Linear(int(pro_hid_dim/2), 3)
...
class Predictor(nn.Module):
    def __init__(self, seq_encoder, struc_encoder, seq_struc_fusion, goterm_encoder, pro_go_cross_fusion, classification_layer, add_structure, add_goterm):
        super().__init__()
