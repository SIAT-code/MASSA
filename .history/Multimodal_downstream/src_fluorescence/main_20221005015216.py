...
if __name__ == "__main__":
    ...
    # data path
    data_scale = "100"  # 100, 21446
    dir_input = "dataset/pretrain_benchmark/fluorescence/sequence_go_structure_%s/" % data_scale
    train_tokens_input = "dataset/pretrain_benchmark/fluorescence/sequence_go_structure_%s/sequence_go_train.txt" % data_scale
    dev_tokens_input = "dataset/pretrain_benchmark/fluorescence/sequence_go_structure_%s/sequence_go_valid.txt" % data_scale
    test_tokens_input = "dataset/pretrain_benchmark/fluorescence/sequence_go_structure_%s/sequence_go_test.txt" % data_scale
    ...
    if do_train:
        ...
        path_model = 'src_fluorescence/output/model-%s/' % current_time
        """Output files."""
        ...
        for epoch in range(236, epochs+1):
        ...
        plot_train_dev_metric(list(range(1, epochs+1)), loss_train_epochs, loss_dev_epochs, path_model, 'loss', 'fluorescence')
        plot_train_dev_metric(list(range(1, epochs+1)), rmse_train_epochs, rmse_dev_epochs, path_model, 'rmse', 'fluorescence')
        plot_train_dev_metric(list(range(1, epochs+1)), mae_train_epochs, mae_dev_epochs, path_model, 'mae', 'fluorescence')
        plot_train_dev_metric(list(range(1, epochs+1)), spear_train_epochs, spear_dev_epochs, path_model, 'spearman', 'fluorescence')
    ...
    if do_test:
        if not best_model:
            best_model_state_dict = torch.load("src_fluorescence/output/model-2022-07-28-11:37:35/model--2022-07-28-11:37:35.pth", map_location=torch.device('cpu'))
